...
+(id)sharedInstace
{
    static CustomIOS7AlertView *alert;
...
-(void)popAlert:(NSString *)lableText
{
    ...
    CGSize size= [label.text sizeWithFont:label.font constrainedToSize:CGSizeMake(300, 100) lineBreakMode:NSLineBreakByCharWrapping];
...
- (void)show
{
    ...
    if ([buttonTitles count]==0) {
        [NSTimer scheduledTimerWithTimeInterval:0.8 target:self selector:@selector(dismissTan) userInfo:nil repeats:NO];
    }
}
