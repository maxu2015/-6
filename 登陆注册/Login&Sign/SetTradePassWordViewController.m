//
//  SetTradePassWordViewController.m
//  Login
//
...
#import "SetTradePassWordViewController.h"
#import "Header.h"
@interface SetTradePassWordViewController ()

@end

@implementation SetTradePassWordViewController
...
- (void)viewDidLoad {
    ...
    NSArray *array = [NSArray arrayWithObjects:@"   请输入身份证号",@"   请输入手机号",@"   请输入验证码",@"   请输入6位新密码",@"   再次输入新密码", nil];
    for (int i=0; i<5; i++) {
