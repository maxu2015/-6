...
//    [self addSubview:self.pageControl];
    ...
    self.skipButton = [[UIButton alloc] initWithFrame:CGRectMake(Width_mainScreen/2-40, self.pageControl.frame.origin.y, 80, 30)];
    
    [self.skipButton setAutoresizingMask: UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin];
    
    [self.skipButton setBackgroundImage:[UIImage imageNamed:@"马上进入－按钮"] forState:UIControlStateNormal];
    [self.skipButton setBackgroundImage:[UIImage imageNamed:@"马上进入－按钮点击事件"] forState:UIControlStateHighlighted];
