...
-(void)setTableView
{
    ...
    if (device_is_iphone_5) {
        _tableViewList=[[UITableView alloc]initWithFrame:CGRectMake(0, 30, 550, SCREEN_HEIGHT-32-64-30) style:UITableViewStylePlain];
    }
    else{
        _tableViewList=[[UITableView alloc]initWithFrame:CGRectMake(0, 30, 550, SCREEN_HEIGHT-32-64-30) style:UITableViewStylePlain];
    }
    ...
    if (device_is_iphone_5) {
        _detailTableVIewList=[[UITableView alloc]initWithFrame:CGRectMake(0, 30, 710, SCREEN_HEIGHT-32-64-30) style:UITableViewStylePlain];
    }
    else{
        _detailTableVIewList=[[UITableView alloc]initWithFrame:CGRectMake(0, 30, 710, SCREEN_HEIGHT-32-64-30) style:UITableViewStylePlain];
    }
    ...
    _scrollView=[[UIScrollView alloc]initWithFrame:CGRectMake(120, 0, SCREEN_WIDTH - 120, SCREEN_HEIGHT-32-64)];
    _scrollView.showsHorizontalScrollIndicator=NO;
    _scrollView.bounces=NO;
    _scrollView.delegate=self;
    [self.view addSubview:_scrollView];
    [_scrollView addSubview:_detailTableVIewList];
    _scrollView.contentSize=CGSizeMake(710, SCREEN_HEIGHT-30-64-38-48);
...
-(void)requestData
{//[[NSUserDefaults standardUserDefaults]objectForKey:USERNICKNAME]]
    _urlString=[NSString stringWithFormat:@"http://app.myfund.com:8484/Service/DemoService.svc/GetFundOptionalNew?type=%d&UserName=%@",0,[[_user userInfoDic] objectForKey:@"UserName"]];
